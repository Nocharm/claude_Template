...
| paragraph.numbering | ⚠️ | P1 — auto/manual 스키마 비대칭 |
| paragraph.indent | ✅ | twips |
| paragraph.alignment | ✅ | jc val |
| paragraph.runs | ✅ | |
| paragraph.soft_breaks | ⚠️ | P2 — 빈 run quirk |
| paragraph.raw_xml | ✅ | `--raw-xml` 옵션 |
| image.{anchor, file_name, format, width, height, kind} | ✅ | |
| image.caption | ❌ | P0 — 잘못된 매칭 |
| table.{rows, cols, merged_cells, cells, caption} | ✅ | caption은 P0 영향 받음 |
| cross_reference.{ref_id, target_bookmark, display_text, paragraph_index, run_position} | ⚠️ | P3 — ref_id 항상 null |
| bookmarks (스펙 외 추가) | ✅ | |
